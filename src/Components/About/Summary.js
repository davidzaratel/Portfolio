  ...
  return (
    <div>
        ...
        <TextContainer>
            ...
            <p>
                On the other hand, I love to try new experiences, get to know people from all over the world and learn about other cultures. I'm a true believer
                that there's always something you can learn from someone else, that's why I really like to work with other people, collaborate and take into 
                account different points of view to get to the best solution as a team. 
            </p>
        </TextContainer>
    </div>
  )
